...
def show_details_page():
    ...
    with col2:
        ...
        st.divider()
        st.subheader("https://github.com/TheAceOfficials/movie-agent-capstone/blob/main/icons/series.png?raw=true Where to Watch (India)")
            ...
            if msg["type"] == "text":
                ...
                for item_idx, item in enumerate(msg["content"]):
                    with cols[item_idx % 5]:
                        ...
                        type_icon = "https://github.com/TheAceOfficials/movie-agent-capstone/blob/main/icons/series.png?raw=true" if item['type'] == 'tv' else "🎬"
